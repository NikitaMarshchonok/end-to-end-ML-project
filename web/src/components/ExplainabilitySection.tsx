import { ExplainRange, Factor } from '@/services/api';
...
const ExplainabilitySection = ({ factors, ranges, currency = 'ILS' }: ExplainabilitySectionProps) => {
  ...
  return (
    <div className="bg-card rounded-2xl shadow-card p-6 border border-border animate-slide-up">
      ...
      {ranges && ranges.length > 0 && (
        <div className="mb-6">
          <h4 className="text-sm font-medium text-foreground mb-3">Prediction Ranges</h4>
